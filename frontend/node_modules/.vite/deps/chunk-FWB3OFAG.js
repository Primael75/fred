...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React9 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState = React9.useState, useEffect = React9.useEffect, useLayoutEffect = React9.useLayoutEffect, useDebugValue = React9.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React9 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef2 = React9.useRef, useEffect = React9.useEffect, useMemo3 = React9.useMemo, useDebugValue = React9.useDebugValue;
...
var TreeViewContext = React3.createContext(null);
...
// node_modules/@mui/x-tree-view/esm/internals/TreeViewProvider/useTreeViewBuildContext.js
...
function TreeViewProvider(props) {
  ...
  const styleContextValue = React5.useMemo(() => ({
    classes,
    slots: {
...
var reactMajor_default = parseInt(React7.version, 10);
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/items/utils.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/items/selectors.js
var EMPTY_CHILDREN = [];
var itemsSelectors = {
  /**
  ...
  itemParentId: createSelector((state, itemId) => {
    var _a;
    return ((_a = state.itemMetaLookup[itemId]) == null ? void 0 : _a.parentId) ?? null;
  }),
  /**
  ...
  itemDepth: createSelector((state, itemId) => {
    var _a;
    return ((_a = state.itemMetaLookup[itemId]) == null ? void 0 : _a.depth) ?? 0;
  }),
  /**
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/id/selectors.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/items/TreeViewItemsPlugin.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/expansion/selectors.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/selection/selectors.js
...
var isItemSelectableSelector = createSelector((state, itemId) => {
  var _a;
  return ((_a = state.itemMetaLookup[itemId]) == null ? void 0 : _a.selectable) ?? true;
});
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/focus/selectors.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/lazyLoading/selectors.js
var lazyLoadingSelectors = {
  ...
  isItemLoading: createSelector((state, itemId) => {
    var _a;
    return ((_a = state.lazyLoadedItems) == null ? void 0 : _a.loading[itemId ?? TREE_VIEW_ROOT_PARENT_ID]) ?? false;
  }),
  /**
  ...
  itemHasError: createSelector((state, itemId) => {
    var _a;
    return !!((_a = state.lazyLoadedItems) == null ? void 0 : _a.errors[itemId ?? TREE_VIEW_ROOT_PARENT_ID]);
  }),
  /**
   * Get an item error.
   */
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/labelEditing/selectors.js
var labelSelectors = {
  /**
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/expansion/TreeViewExpansionPlugin.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/selection/itemPlugin.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/selection/TreeViewSelectionPlugin.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/focus/TreeViewFocusPlugin.js
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FWB3OFAG.js.map
