...
import "./chunk-KP5YJLX4.js";
import "./chunk-GOEXIXT3.js";
import {
  composeClasses,
...
function useExtractSimpleTreeViewParameters(props) {
  const {
    ...
    // Forwarded props
  } = props, forwardedProps = _objectWithoutPropertiesLoose(props, _excluded);
...
// node_modules/@mui/x-tree-view/esm/internals/hooks/useTreeViewRootProps.js
...
var TreeViewChildrenItemContext = React2.createContext(null);
...
function TreeViewChildrenItemProvider(props) {
  ...
  const childrenIdAttrToIdRef = React2.useRef(/* @__PURE__ */ new Map());
  React2.useEffect(() => {
    if (!rootRef.current) {
      return;
    }
...
// node_modules/@mui/x-tree-view/esm/internals/hooks/useTreeViewStore.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/expansion/utils.js
...
// node_modules/@mui/x-tree-view/esm/internals/MinimalTreeViewStore/MinimalTreeViewStore.utils.js
...
// node_modules/@mui/x-tree-view/esm/internals/MinimalTreeViewStore/TimeoutManager.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/labelEditing/itemPlugin.js
var React5 = __toESM(require_react(), 1);

// node_modules/@mui/x-tree-view/esm/internals/plugins/keyboardNavigation/TreeViewKeyboardNavigationPlugin.js
...
var TreeViewKeyboardNavigationPlugin = class {
  ...
  constructor(store) {
     ...
     */
    __publicField(this, "handleItemKeyDown", async (event, itemId) => {
      var _a;
...
// node_modules/@mui/x-tree-view/esm/internals/MinimalTreeViewStore/TreeViewItemPluginManager.js
...
// node_modules/@mui/x-tree-view/esm/internals/MinimalTreeViewStore/MinimalTreeViewStore.js
...
// node_modules/@mui/x-tree-view/esm/internals/plugins/jsxItems/itemPlugin.js
var React6 = __toESM(require_react(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var useJSXItemsItemPlugin = ({
  props,
  rootRef,
  contentRef
}) => {
  ...
  const parentContext = React6.useContext(TreeViewChildrenItemContext);
  ...
  const pluginContentRef = React6.useRef(null);
  ...
  const isMountedRef = React6.useRef(true);
  ...
  React6.useEffect(() => {
    var _a;
    if (label) {
      return store.jsxItems.mapLabelFromJSX(itemId, (((_a = pluginContentRef.current) == null ? void 0 : _a.textContent) ?? "").toLowerCase());
    }
    return void 0;
  }, [store, itemId, label]);
  return {
...
if (true) jsxItemsitemWrapper.displayName = "jsxItemsitemWrapper";

// node_modules/@mui/x-tree-view/esm/internals/plugins/jsxItems/TreeViewJSXItemsPlugin.js
var TreeViewJSXItemsPlugin = class {
  constructor(store) {
     ...
     */
    __publicField(this, "itemOwners", /* @__PURE__ */ (() => /* @__PURE__ */ new Map())());
    /**
     ...
     */
    __publicField(this, "upsertJSXItem", (item, ownerToken) => {
     ...
     */
    __publicField(this, "mapLabelFromJSX", (itemId, label) => {
     ...
     */
    __publicField(this, "setJSXItemsOrderedChildrenIds", (parentId, orderedChildrenIds) => {
...
// node_modules/@mui/x-tree-view/esm/internals/SimpleTreeViewStore/SimpleTreeViewStore.utils.js
...
// node_modules/@mui/x-tree-view/esm/internals/SimpleTreeViewStore/SimpleTreeViewStore.js
var SimpleTreeViewStore = class extends MinimalTreeViewStore {
  constructor(parameters) {
    ...
    __publicField(this, "jsxItems", (() => new TreeViewJSXItemsPlugin(this))());
  }
  updateStateFromParameters(parameters) {
...
var SimpleTreeView = React7.forwardRef(function SimpleTreeView2(inProps, forwardedRef) {
  ...
  return (0, import_jsx_runtime3.jsx)(TreeViewProvider, {
    ...
    apiRef,
    rootRef: ref,
    children: (0, import_jsx_runtime3.jsx)(TreeViewChildrenItemProvider, {
      itemId: null,
      idAttribute: null,
